        ...
        http
                ...
                .authorizeHttpRequests((requests) -> requests
                        .requestMatchers(HttpMethod.POST, "/login", "/register").permitAll()
                                ...
                                .requestMatchers(HttpMethod.GET,"/api/clients/**").hasAuthority("PERM_VIEW_USERS")
                                .requestMatchers(HttpMethod.PUT,"/api/clients/**").hasAuthority("PERM_EDIT_USERS")
                                .requestMatchers(HttpMethod.DELETE,"/api/clients/**").hasAuthority("PERM_DELETE_USERS")
                                .requestMatchers(HttpMethod.DELETE,"/api/orderItems/**").hasAuthority("PERM_DELETE_ITEMS")
                                .requestMatchers(HttpMethod.GET,"/api/orderItems/**").hasAuthority("PERM_VIEW_ITEMS")
                                .requestMatchers(HttpMethod.POST,"/api/orderItems/**").hasAuthority("PERM_ADD_ITEMS")
                                .requestMatchers(HttpMethod.PUT,"/api/orderItems/**").hasAuthority("PERM_EDIT_ITEMS")
